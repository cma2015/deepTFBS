...
class Train(object):
    ...
    def training(self) -> None:
        ...
        if self.args.eval_after_pre_train:
            ...
            testScore = custom_model.predict(test_input1, batch_size = batch_size)
